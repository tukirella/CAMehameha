...
A Python utility designed to run directly in OCI Cloud Shell, scanning all compartments to identify abandoned, underutilized, or misconfigured Classic & Network Load Balancers.
