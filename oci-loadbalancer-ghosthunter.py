...
def show_banner():
    ...
    print_colored("║                        🔍 LoadBalancer - Android 16 Cleanse 🔍               ║", Colors.HEADER)
    print_colored("║                              OCI CAMehameha Battle Tool                       ║", Colors.HEADER)
...
{no_ghosts_section}
        ...
        <div class="footer">
            <p>Generated by Your OCI CAMehameha Reporetory </p>
